...
uint256 hashGenesisBlock("0x442eec35c48fd1ad8725c65394b1cde142def3109210c80d5230f6df1a9855b8");
...
{
	if (nHeight < 11520) return COIN*60; //shop
    int64 nSubsidy = 2 * COIN;
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 24 * 60 * 60; // Streamcoin: 1 day
static const int64 nTargetSpacing = 60; // StreamCoin: 1 minute
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xca2d4ac787382080678ece94f4de5966af043d06d8392013cfdc176fffcc3ed8");
}
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "StreamCoin is the best cryptocurrency availabe. Started 29 jan. 2014 - NO PREMINING";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1390992515;
        block.nBits    = 0x1e0ffff0;
        block.nNonce = 4093587;

        if (fTestNet)
        {
	    block.nTime    = 1390990932;
            block.nNonce   = 1757792;            
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfa94bcf82d8723edd1e69ba9657167656895a1e889174b7fea7de8f5cf044b2f"));
